# Projeto de Microcontroladores <br> Relógio Digital Configurável <br> Engenharia de Computação 
...
![alt text](https://raw.githubusercontent.com/faelsriegel/ProjetoMicrocontroladores/branch/path/to/Microcontroladores - Projeto Relógio Digital.png)
